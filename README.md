...
- **[React(vite) + TypeScript + Shadcn-ui](https://github.com/ajaykumarn3000/template/tree/react-ts-shadcn)** *(current branch)*
...
# Get Started with React(vite) + TypeScript + Shadcn-ui

```bash
# Clone repository                                                                        
git clone -b next-ts-shadcn https://github.com/ajaykumarn3000/template.git
```
